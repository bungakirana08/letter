...
function initMusic() {
  ...
  function tryPlayMusic() {
    ...
    music.play().then(() => {
      ...
      // browser masih blokir, nanti coba lagi pas interaksi berikutnya
    });
  }

  // Coba mainkan musik begitu ada interaksi pertama di halaman
  // (browser butuh gesture user sebelum izinkan audio autoplay)
